<template>
  <div class="home-page">
    ...
    <div class="article-container">
      <homepage-content title="热度文章"
                        :show-list="techshare"></homepage-content>
    </div>

    <!-- 大家说前三 -->
    <div class="article-container">
      <homepage-content :title="'大家说'"
                        :show-list="techshare"></homepage-content>
    </div>
...
export default {
  ...
  methods: {
    ...
    getHotArticles() {
      service.getHotArticles(this.tags, res => {
